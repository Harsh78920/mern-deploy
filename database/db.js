...
const Connection = async() => {
    ...
    const URL=`mongodb://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@ac-n2dcwv3-shard-00-00.kem3hg1.mongodb.net:27017,ac-n2dcwv3-shard-00-01.kem3hg1.mongodb.net:27017,ac-n2dcwv3-shard-00-02.kem3hg1.mongodb.net:27017/?ssl=true&replicaSet=atlas-a0vgfr-shard-0&authSource=admin&retryWrites=true&w=majority&appName=blog-app`;
    try{
